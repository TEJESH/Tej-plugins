...
(define (sprocketholes aimg adraw phototext dx1 dx2 font framenumber framenumberhole firstsh shcolor letteringcolor)
...
(script-fu-register "sprocketholes"
...
(script-fu-menu-register "sprocketholes" _"<Image>/Filters/new")
