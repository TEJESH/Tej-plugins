...
(define (national-geographic aimg adraw shadowopacity
...
(script-fu-register "national-geographic"
...
(script-fu-menu-register "national-geographic" _"<Image>/Filters/new")
